  ...
  },
  {
    ...
    sampleWorks: [
      ...
      },
      {
        difficulty: Difficulty.EASY,
        title:
          "Different Plans Price and Features Comparison Cards (Free, Basic, Pro)",
      },
      {
  ...
  },
  {
    ...
    sampleWorks: [
      ...
      },
      {
        difficulty: Difficulty.MEDIUM,
        title:
          "Social Media Growth Tracker Dashboard with Different Statistics and Charts for Views, Likes, New Subscribers and more",
      },
      {
        difficulty: Difficulty.MEDIUM,
        title: "Quiz (LMS)",
      },
      {
        difficulty: Difficulty.MEDIUM,
        title:
          "Operating System App Menu with Lock Screen (Windows 8; Aurora New Tab)",
      },
      {
        difficulty: Difficulty.MEDIUM,
    ...
    sampleWorks: [
      {
        difficulty: Difficulty.HARD,
        title:
          "Iran: Culture | History | Sightseeing | Agriculture | Technical, Sports and Military Achievements",
        isPriority: true,
      },
      {
        difficulty: Difficulty.MEDIUM,
  ...
  },
  {
    ...
    sampleWorks: [
      ...
      },
      {
        difficulty: Difficulty.MEDIUM,
        title:
          "Time Tracker for Cities Around The World with Add/Remove Clock Support",
      },
      {
        difficulty: Difficulty.MEDIUM,
        title: "Mouse Tester",
